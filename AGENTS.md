...
- PR code and PR CI never receive Cloudflare credentials. Preview administration belongs to protected default-branch control workflows; production deployment remains protected and `main`-only.
