...
-- retries collapse, but the same row id from another profile remains distinct.
-- received_at plus id provides deterministic newest-first pagination; the tool-prefixed
-- sibling index keeps exact-tool pages bounded. Daily pruning retains six months.
