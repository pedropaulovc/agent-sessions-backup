...
// dev/typecheck only; NOT paired with any private key ever set as the
// OIDC_SIGNING_KEY Worker secret. Swap this for the real public JWK(s) at M4 deploy time
