...
test('builds the collector upload URL with per-segment encoding', () => {
  const target = uploadTarget('https://pr-42-app.sessions-ppe.workers.dev', {
    machine: 'amet',
    store: 'export-inbox',
  ...
  assert.equal(
    target,
    'https://pr-42-app.sessions-ppe.workers.dev/api/v1/files/amet/export-inbox/a%20dir/export.abc%231.zip',
  );
});
