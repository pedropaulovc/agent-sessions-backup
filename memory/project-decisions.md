...
- Public GitHub repo; protected `main`-only deploy. ~~Workers Builds auto-deploy + DEV_AUTH bearer previews~~ SUPERSEDED 2026-08: per-PR previews are provisioned by the protected `Preview Control` workflow in a dedicated non-production account (PRs #83–#116, `infra/cf/deploy.md`), and DEV_AUTH is fully retired (PR #118).
